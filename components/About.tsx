...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="bg-white dark:bg-background-dark py-32 3xl:py-48 px-6 w-full">
      {/* Expanded Wrapper */}
      <div className="max-w-screen-3xl mx-auto">
        ...
        <div className="flex flex-col items-start md:items-end text-left md:text-right mb-32">
          <div className="max-w-3xl 3xl:max-w-4xl">
            ...
            {/* Keeping text narrow for readability */}
            <p className="font-sans text-sm md:text-base 3xl:text-lg text-gray-700 dark:text-gray-400 leading-loose tracking-wide max-w-lg 3xl:max-w-xl ml-auto font-light border-l border-primary/10 pl-6 md:pl-0 md:border-l-0 md:border-r md:pr-6">
              {sobre.descricao}
            </p>
          </div>
        </div>
