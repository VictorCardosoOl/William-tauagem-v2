...
const Concept: React.FC = () => {
  ...
  return (
    <section className="relative w-full py-32 px-6 md:px-12 bg-paper-warm dark:bg-[#181818] overflow-hidden transition-colors duration-1000">
      
      <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-16 lg:gap-32">
        
        <div className="lg:w-1/3 relative">
          <div className="lg:sticky lg:top-32">
            <h2 className="font-serif font-light text-6xl md:text-9xl text-ink-black dark:text-gray-100 uppercase tracking-tighter leading-[0.8] mb-8">
              {concept.titulo}
            </h2>
        ...
        <div className="lg:w-2/3 flex flex-col gap-32">
          ...
          <div className="max-w-2xl">
            <p className="font-serif text-3xl md:text-5xl leading-tight text-ink-black dark:text-gray-200 italic font-thin">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
             ...
             <div className="flex flex-col gap-16">
                <p className="font-sans text-xs md:text-sm leading-loose tracking-wide text-ink-dark dark:text-gray-400 font-light border-l border-ink-black/20 pl-6">
