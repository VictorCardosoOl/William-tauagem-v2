      ...
      <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-16 lg:gap-32">
        ...
        <div className="lg:w-1/3 relative">
          <div className="lg:sticky lg:top-32">
            ...
            <p className="font-sans text-xs tracking-[0.2em] uppercase opacity-60 font-bold text-accent-sepia">
              {concept.subtitulo}
            </p>
          </div>
        </div>
        ...
        <div className="lg:w-2/3 flex flex-col gap-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-8 items-center">
             ...
             <div className="flex flex-col gap-12">
                <p className="font-sans text-sm md:text-base leading-relaxed text-gray-700 dark:text-gray-400 font-light">
