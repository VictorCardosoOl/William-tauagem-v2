...
const Aftercare: React.FC = () => {
  ...
  return (
    <section id="cuidados" className="py-32 px-6 max-w-7xl mx-auto bg-paper-light dark:bg-paper-dark">
      ...
      <div className="flex flex-col items-center mb-24 text-center space-y-8">
        ...
        <h2 className="font-serif font-light text-4xl md:text-6xl italic text-ink-black dark:text-gray-100 max-w-3xl leading-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {ITENS_CUIDADOS.map((item, index) => (
          <article 
            key={index} 
            className="bg-white dark:bg-white/5 p-10 md:p-12 border border-ink-light dark:border-white/5 shadow-sm hover:shadow-md transition-shadow duration-300"
          >
            ...
            <h3 className="font-serif font-light text-4xl mb-6 italic text-ink-black dark:text-white">
              {item.titulo}
            </h3>
            
            <p className="font-sans text-xs text-ink-medium dark:text-gray-400 leading-loose tracking-wide mb-10 font-light">
              {item.descricao}
            </p>
            ...
            <ul className="space-y-4">
              {item.lista.map((step, stepIndex) => (
                <li key={stepIndex} className="flex items-start font-sans text-[10px] tracking-wide text-ink-black dark:text-gray-300 leading-relaxed font-bold">
