        ...
        <div className="w-full border-t border-ink-black/5 dark:border-white/5">
            ...
            <div className="max-w-screen-4xl mx-auto grid grid-cols-1 md:grid-cols-12 min-h-screen">
                ...
                <div className="md:col-span-7 border-r border-ink-black/5 dark:border-white/5 flex flex-col justify-center items-center py-32 md:py-0 px-8 relative">
                    ...
                    <div className="max-w-2xl 3xl:max-w-4xl text-center">
                ...
                <div className="md:col-span-4 flex flex-col">
                    ...
                    <div className="flex-1 p-12 md:p-16 3xl:p-24 border-b border-ink-black/5 dark:border-white/5 hover:bg-white/40 dark:hover:bg-black/20 transition-colors duration-500 flex flex-col justify-center group">
                        ...
                        {/* Text constraints applied within wider box */}
                    ...
                    <div className="flex-1 p-12 md:p-16 3xl:p-24 hover:bg-white/40 dark:hover:bg-black/20 transition-colors duration-500 flex flex-col justify-center group">
                         <div className="flex items-center gap-4 mb-8">
